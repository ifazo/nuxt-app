  ...
  <header class="bg-white">
    <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
      ...
      <PopoverGroup class="hidden lg:flex lg:gap-x-12">
        ...
        <NuxtLink to="/categories" class="text-sm font-semibold leading-6 text-gray-900">Category</NuxtLink>
        <NuxtLink to="/blogs" class="text-sm font-semibold leading-6 text-gray-900">Blog</NuxtLink>
        ...
        <div class="mt-6 flow-root">
          <div class="-my-6 divide-y divide-gray-500/10">
            <div class="space-y-2 py-6">
              ...
              <NuxtLink to="#" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">Features</NuxtLink>
              <NuxtLink to="#" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">Marketplace</NuxtLink>
              <NuxtLink to="#" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">Company</NuxtLink>
            </div>
            <div class="py-6">
